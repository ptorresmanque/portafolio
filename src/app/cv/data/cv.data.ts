...
const EXPERIENCE_ES: CvData['experience'] = [
  {
    ...
    bullets: [
      ...
      'Construí una librería accesible (combobox, modal con focus trap, navegación por teclado) que se convirtió en estándar interno del gobierno regional.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Evolucioné de frontend Angular a gestionar y desplegar microservicios backend en Java + Spring Boot sobre Kubernetes.',
    ],
  ...
  },
  {
    ...
    period: '2019 — 2022',
    bullets: [
      'Unifiqué la telemetría y los SCADA de las 4 empresas del grupo (Aguas Altiplano, Chañar, Araucanía, Magallanes) en una sola plataforma, antes fragmentada en versiones obsoletas y sin parches.',
...
const EXPERIENCE_EN: CvData['experience'] = [
  {
    ...
    bullets: [
      ...
      'Built an accessible component library (combobox, modal with focus trap, keyboard navigation for long lists) that became the internal standard for the regional government.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Grew from Angular frontend to owning and deploying backend microservices in Java + Spring Boot on Kubernetes.',
    ],
    stack: ['Angular', 'Java', 'Spring Boot', 'Kubernetes'],
  },
  {
    ...
    period: '2019 — 2022',
    bullets: [
      'Unified telemetry and SCADA systems of the 4 companies in the group (Aguas Altiplano, Chañar, Araucanía, Magallanes) into a single platform, previously fragmented across outdated, unpatched versions.',
